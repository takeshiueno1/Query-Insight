...
- 社員のスキル、得意分野、業務経歴、資格、自己ステータス、上長評価、経営者承認を根拠と履歴付きで管理する社内Webアプリケーションである。内部データ型`KNOWLEDGE`は維持する。
...
- 本人の自己評価入力は廃止済みとし、承認済みのスキル40％、得意分野20％、業務経歴25％、資格15％から本人編集不可の自己ステータスを算出する。上長評価は直属上長が6軸をS/A/B/C/D/Fで入力し、`OFFICER/ALL`の最終承認後だけ本人へ公開する。
